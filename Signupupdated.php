...
example-navbar-collapse-1">
 ...
 <li>
 <a class="page-scroll" href="Loginuser.php">Log in</a>
 </li>
...
<form method="post" action="register.php"> 
   ...
   <input class="form-control" type="email" style="color:#555555" placeholder= "E-mail*" name="email" value="<?php echo $email;?>">
  ...
  <input class="form-control" type="password" style="color:#555555" placeholder= "Confirm Password*" name="password1" required value="<?php echo $confirmPW;?>">
...
echo "<h1>you have registered sucessfully</h1>";
  ...
  echo  "<u> Profile Array</u><br/>";
$joined =longdate(time());

$profile = compact("name", "email", "password", "joined");
//echo print_r($profile);
foreach($profile as $info => $get){
echo  $info . " : " . $get. "<br/>";}

echo "<a href='YourProfilePage.php' class='page-scroll btn btn-xl'>LOG IN</a>";
}
